  ...
  return (
    <section className="px-6 py-20 md:py-28 bg-marfim" id="welcome">
      <div className="max-w-2xl mx-auto text-center">
        <p className="font-serif font-light text-sm uppercase tracking-[0.3em] text-charcoal/70 mb-2">
          Sejam muito bem-vindos ao
        </p>
        <h2 className="font-display font-medium text-base sm:text-lg uppercase tracking-[0.2em] text-charcoal mb-10">
          nosso site de casamento
        </h2>

        <div className="space-y-5 font-serif font-light text-base text-charcoal/85 leading-relaxed text-left">
          <p>
